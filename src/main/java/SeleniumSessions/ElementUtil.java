...
public class ElementUtil {
	...
	//ctrl + o to get the blueprint/list of the methods, driver, constructor in this class
	...
	/**
	 * this method is used to select the value from the Drop Down - without using Select class in Selenium
	 * @param locator
	 * @param locatorValue
	 * @param value
	 */
